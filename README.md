...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/g2p-en-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13699&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/g2p-en-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `g2p-en` can be installed with:

```
conda install g2p-en
```

It is possible to list all of the versions of `g2p-en` available on your platform with:
